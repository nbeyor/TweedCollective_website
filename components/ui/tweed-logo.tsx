...
export default function TweedLogo({ size = 36, className = '', animated = true }: TweedLogoProps) {
  return (
    ...
    >
      ...
      {/* Vertical threads (violet) - offset to show weaving */}
      <line x1="10" y1="6" x2="10" y2="14" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" />
      <line x1="10" y1="22" x2="10" y2="30" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" />
      <line x1="18" y1="6" x2="18" y2="22" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" />
      <line x1="26" y1="14" x2="26" y2="30" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" />

      {/* Node intersections (violet circles) */}
      ...
      <circle cx="26" cy="26" r="2" fill="#8B5CF6">
        {animated && (
...
export function TweedLogoSimple({ size = 24, className = '' }: Omit<TweedLogoProps, 'animated'>) {
  return (
    ...
    >
      ...
      <line x1="7" y1="4" x2="7" y2="20" stroke="#8B5CF6" strokeWidth="1.5" />
      <line x1="12" y1="4" x2="12" y2="20" stroke="#8B5CF6" strokeWidth="1.5" />
      <line x1="17" y1="4" x2="17" y2="20" stroke="#8B5CF6" strokeWidth="1.5" />
      <circle cx="7" cy="7" r="1.5" fill="#8B5CF6" />
      <circle cx="12" cy="12" r="2" fill="#8B5CF6" />
      <circle cx="17" cy="17" r="1.5" fill="#8B5CF6" />
    </svg>
  )
}
