      ...
      >
        <defs>
          ...
          <pattern id="tweedWeave" width="60" height="60" patternUnits="userSpaceOnUse">
            ...
            <line x1="0" y1="30" x2="60" y2="30" stroke="#8C7B6B" strokeWidth="1" opacity="0.3" />
            <line x1="0" y1="45" x2="60" y2="45" stroke="#4A5D4C" strokeWidth="1" opacity="0.4" />
            
            {/* Vertical threads (violet) */}
            <line x1="15" y1="0" x2="15" y2="60" stroke="#8B5CF6" strokeWidth="1" opacity="0.3" />
            <line x1="30" y1="0" x2="30" y2="60" stroke="#8B5CF6" strokeWidth="1" opacity="0.2" />
            <line x1="45" y1="0" x2="45" y2="60" stroke="#8B5CF6" strokeWidth="1" opacity="0.3" />
            
            {/* Diagonal accents */}
            <line x1="0" y1="0" x2="60" y2="60" stroke="#22D3EE" strokeWidth="0.5" opacity="0.15" />
            <line x1="60" y1="0" x2="0" y2="60" stroke="#8B5CF6" strokeWidth="0.5" opacity="0.1" />
          </pattern>
        ...
        <g className="network-nodes">
          ...
          {/* Center area */}
          <circle cx="50%" cy="45%" r="4" fill="#8B5CF6" opacity="0.3">
          ...
          {/* Bottom left */}
          <circle cx="25%" cy="75%" r="2.5" fill="#22D3EE" opacity="0.25">
            <animate attributeName="opacity" values="0.15;0.5;0.15" dur="4.5s" repeatCount="indefinite" begin="1.5s" />
          </circle>
          
          {/* Bottom right */}
          <circle cx="75%" cy="80%" r="3" fill="#8B5CF6" opacity="0.35">
          ...
          <line x1="15%" y1="20%" x2="18%" y2="25%" stroke="#8B5CF6" strokeWidth="0.5" opacity="0.15" />
          <line x1="80%" y1="15%" x2="85%" y2="22%" stroke="#8B5CF6" strokeWidth="0.5" opacity="0.15" />
          <line x1="50%" y1="45%" x2="75%" y2="80%" stroke="#22D3EE" strokeWidth="0.5" opacity="0.1" />
          <line x1="25%" y1="75%" x2="50%" y2="45%" stroke="#8B5CF6" strokeWidth="0.5" opacity="0.1" />
        </g>
      </svg>
    </div>
  )
