  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        pipelineCallout: 'Together these form an AI-driven content production pipeline that can reduce revision cycles, accelerate MLR readiness, and increase revenue-per-employee.',
        tableSections: [
          {
            title: 'Future-State AI Editorial Pipeline (Core Value Drivers)',
            highlight: true,
            headers: ['Initiative', 'Description', 'Value Source', 'Value Potential'],
            rows: [
        ...
        cards: [
          { name: 'DynAImic Content', description: 'Generates draft marketing content across channels', icon: 'FileText', highlight: true },
          ...
          { name: 'Route Reagent', description: 'Validates content vs style and brand rules', icon: 'Rocket', highlight: true },
        ],
      },
    },
  },
    ...
    content: {
      ...
      props: {
        ...
        categories: [
          {
            ...
            variant: 'green',
            items: [
              'Rationalize the AI product portfolio and combine adjacent products along core workflow lines: Editorial Pipeline (DynAImic Content + Annotation Activation + Compliance Core + Route Reagent), HCP Intelligence (Pantheon + Plexus + Sentiment Tracker), and Research-to-Insight (MagpAI + BloomLab + PerspectivX)',
        ...
        workflowIntegration: {
          ...
          workflows: [
            { workflow: 'Editorial -> MLR -> Delivery', tools: 'DynAImic Content + Annotation Activation + Compliance Core + Route Reagent', gap: 'Not yet connected end-to-end' },
