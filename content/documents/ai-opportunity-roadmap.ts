...
export const slides: SlideData[] = [
  ...
  // ================================================================
  // SLIDE 2a: EXECUTIVE SUMMARY (1 of 2) — Radar, Strengths & Risks
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        heading: 'Executive Summary (1 of 2)',
  ...
  // ================================================================
  // SLIDE 2b: EXECUTIVE SUMMARY (2 of 2) — Immediate Focus
  // ================================================================
  {
    id: 'executive-summary-2',
    title: 'Executive Summary (2 of 2)',
    type: 'custom',
    content: {
      type: 'custom',
      componentId: 'ExecutiveSummarySlide',
      props: {
        heading: 'Executive Summary (2 of 2)',
        immediateFocus: [
  ...
  // ================================================================
  // SLIDE 13a: EXTERNAL REVENUE (1 of 2) — First 4 products
  // ================================================================
  {
    id: 'external-revenue-1',
    title: 'External Revenue Upside (1 of 2)',
    type: 'custom',
    content: {
      type: 'custom',
      componentId: 'ExternalRevenueSlide',
      props: {
        heading: 'External Revenue Upside (1 of 2)',
        rows: [
  ...
  // ================================================================
  // SLIDE 13b: EXTERNAL REVENUE (2 of 2) — Last 3 products + totals
  // ================================================================
  {
    id: 'external-revenue-2',
    title: 'External Revenue Upside (2 of 2)',
    type: 'custom',
    content: {
      type: 'custom',
      componentId: 'ExternalRevenueSlide',
      props: {
        heading: 'External Revenue Upside (2 of 2)',
        rows: [
  ...
  // ================================================================
  // SLIDE 14a: COMBINED VALUE (1 of 2) — Internal Productivity
  // ================================================================
  {
    id: 'combined-value-waterfall-1',
    title: 'Combined AI Opportunity \u2014 Internal Productivity',
    type: 'custom',
    content: {
      type: 'custom',
      componentId: 'CombinedValueWaterfallSlide',
      props: {
        heading: 'Combined AI Opportunity \u2014 Internal Productivity (1 of 2)',
        internalItems: [
        ...
        footnote: 'Internal values represent labor cost equivalent of productivity freed \u2014 capacity for redeployment or margin improvement, not headcount reduction. Ranges reflect low (basic adoption) to high (targeted workflow automation) scenarios.',
      },
    },
  },

  // ================================================================
  // SLIDE 14b: COMBINED VALUE (2 of 2) — External Revenue + Grand Total
  // ================================================================
  {
    id: 'combined-value-waterfall-2',
    title: 'Combined AI Opportunity \u2014 External Revenue & Total',
    type: 'custom',
    content: {
      type: 'custom',
      componentId: 'CombinedValueWaterfallSlide',
      props: {
        heading: 'Combined AI Opportunity \u2014 External Revenue & Total (2 of 2)',
        externalItems: [
        ...
        footnote: 'External values represent incremental revenue from AI-differentiated products. Ranges reflect low (basic adoption) to high (targeted workflow automation) scenarios.',
      },
    },
  },

  // ================================================================
  // SLIDE 15a: GOVERNANCE (1 of 2) — Readiness Assessment
  // ================================================================
  {
    id: 'governance-1',
    title: 'Governance & Change Management (1 of 2)',
    type: 'custom',
    content: {
      type: 'custom',
      componentId: 'ChangeManagementSlide',
      props: {
        heading: 'Governance & Change Management (1 of 2)',
        readiness: {
  ...
  // ================================================================
  // SLIDE 15b: GOVERNANCE (2 of 2) — Meeting Structure & Discussion
  // ================================================================
  {
    id: 'governance-2',
    title: 'Governance & Change Management (2 of 2)',
    type: 'custom',
    content: {
      type: 'custom',
      componentId: 'ChangeManagementSlide',
      props: {
        heading: 'Governance & Change Management (2 of 2)',
        meetingStructure: [
  ...
  // ================================================================
  // SLIDE 16a: EXECUTION ROADMAP (1 of 2) — Phased Timeline
  // ================================================================
  {
    id: 'roadmap-1',
  ...
  // ================================================================
  // SLIDE 16b: EXECUTION ROADMAP (2 of 2) — Key Recommendations
  // ================================================================
  {
    id: 'roadmap-2',
  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        valueMapping: 'Internal: 80 FTEs × $120K × 5–15% uplift = $480K–$1,440K. This is the single largest internal value line item.',
        leadingIndicators: [
        ...
        valueEstimate: 'Internal: 80 FTEs × $120K × 5–15% uplift = $480K–$1,440K in productivity freed.',
        assumptions: [
  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        valueMapping: 'Internal: 20 FTEs × $140K × 5–15% uplift = $140K–$420K. Indirect: each prevented MLR rejection avoids 3–5 days of rework.',
        leadingIndicators: [
        ...
        valueEstimate: 'Internal: 20 FTEs × $140K × 5–15% uplift = $140K–$420K. Indirect value: each prevented rejection avoids 3–5 days of rework across writers, editors, and compliance staff.',
        assumptions: [
  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        valueMapping: 'External: 10–20 customers × $10K–$40K = $100K–$800K. Internal: 25 FTEs × $105K × 10–20% uplift = $263K–$525K (shared with Practice Master).',
        leadingIndicators: [
        ...
        valueEstimate: 'External: Low — 10 customers × $10K = $100K | High — 20 customers × $40K = $800K. Internal: 25 FTEs × $105K × 10–20% uplift = $263K–$525K (shared with Practice Master).',
        assumptions: [
          'Proprietary engagement data layer is meaningfully richer than IQVIA or H1 alone',
          'Subscription price point ($10K–$40K) validated with at least 5 pilot customers',
  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        valueMapping: 'Internal: 15 FTEs × $130K × 5–15% uplift = $98K–$293K. External: 8–18 projects × $20K–$40K premium = $160K–$720K.',
        leadingIndicators: [
        ...
        valueEstimate: 'Internal: 15 FTEs × $130K × 5–15% uplift = $98K–$293K. External: 8–18 projects × $20K–$40K premium = $160K–$720K.',
        assumptions: [
  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        valueMapping: 'Internal: 200 FTEs × $95K × 1–5% uplift = $190K–$950K. Wide range reflects the data integration question.',
        leadingIndicators: [
        ...
        valueEstimate: '200 FTEs × $95K × 1–5% uplift = $190K–$950K. Wide range reflects the data integration question.',
        assumptions: [
  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        valueMapping: 'Internal: 40 FTEs × $115K × 10–20% uplift = $460K–$920K (shared with BloomLab, PerspectivX). External: $0 (deal sweetener) → 15 boards × $12K = $0–$180K.',
        leadingIndicators: [
        ...
        valueEstimate: 'Internal: 40 FTEs × $115K × 10–20% uplift = $460K–$920K (shared). External: Low — $0 (deal sweetener) | High — 15 boards × $12K = $180K.',
        assumptions: [
