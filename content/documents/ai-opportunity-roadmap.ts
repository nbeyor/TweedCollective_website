  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        rows: [
          { product: 'Pantheon', primaryValueDriver: 'Subscription shift — recurring revenue', lowAssumptions: '10 customers × $80K', lowRevenue: '$800K', highAssumptions: '20 customers × $120K', highRevenue: '$2,400K', rationale: 'Converting <10% of eligible 81qd clients to subscription validates the model shift.' },
  ...
  // ================================================================
  {
    ...
    content: {
      ...
      props: {
        ...
        externalItems: [
          { label: 'Pantheon (subscription)', low: '$800K', high: '$2,400K', midpoint: 1600 },
        ...
        externalTotal: { low: '$1.3M', high: '$5.7M' },
        grandTotal: { low: '$3.4M', high: '$11.1M', pctLow: '2.3%', pctHigh: '7.4%' },
