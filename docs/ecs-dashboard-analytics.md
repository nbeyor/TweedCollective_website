...
- **Purpose:** Per-developer drill-down on adoption and throughput, designed for change management rather than ranking — productivity is scored against a fixed historical bar, never against current teammates.
