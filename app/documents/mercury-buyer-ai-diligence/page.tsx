...
const slides: Slide[] = [
    ...
    content: (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-cream/20 bg-cream/5 mb-8">
          ...
          <span className="text-xs uppercase tracking-wider text-cream/60">AI Due Diligence</span>
        </div>
        <h1 className="text-4xl md:text-6xl font-serif font-light text-cream mb-4 leading-tight">
          Mercury: AI Diligence
        </h1>
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-red-500/30 bg-red-500/10">
          ...
          <span className="text-xs uppercase tracking-wider text-red-300 font-mono">Confidential — Public Sources Only</span>
        </div>
      </div>
    ),
  },
  ...
  // ================================================================
  // SLIDE 3: CHAPTER A — GROWTH THESIS ALIGNMENT EXEC SUMMARY
  // ================================================================
  {
    id: 'growth-thesis-exec',
    title: 'Growth Thesis Alignment — Executive Summary',
    content: (
      <div className="space-y-6 px-4">
        <div>
  ...
  // ================================================================
  {
    ...
    title: 'Growth Projections — Snapshot + Assumptions',
    content: (
      <div className="space-y-6 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-sage-300 mb-2">Chapter A — Growth Thesis Alignment</div>
  ...
  // ================================================================
  // SLIDE 5: OFFERING + AI ↔ GROWTH DRIVERS MATRIX
  // ================================================================
  {
    id: 'offering-ai-growth-matrix',
    title: 'Offering + AI Initiatives ↔ Growth Drivers',
    content: (
  ...
  {
    id: 'ai-roadmap-fit',
    title: 'AI Roadmap Fit to Growth Thesis',
    content: (
      <div className="space-y-6 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-sage-300 mb-2">Chapter A — Growth Thesis Alignment</div>
  ...
  {
    id: 'scenarios',
    title: 'Scenarios for Growth & Disruption Outcomes',
    content: (
      <div className="space-y-6 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-sage-300 mb-2">Chapter A — Growth Thesis Alignment</div>
  ...
  // ================================================================
  // SLIDE 8: DISRUPTION RISK — EXEC SUMMARY
  // ================================================================
  {
    id: 'disruption-risk-exec',
    title: 'Disruption Risk — Executive Summary',
    content: (
      <div className="space-y-6 px-4">
        <div>
  ...
  // ================================================================
  // SLIDE 9: WHO COULD DISRUPT
  // ================================================================
  {
    id: 'who-could-disrupt',
    title: 'Who Could Disrupt',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-purple-300 mb-2">Chapter B — Disruption Risk</div>
  ...
  // ================================================================
  // SLIDE 10: WHAT THEY WOULD BUILD
  // ================================================================
  {
    id: 'what-they-would-build',
    title: 'What the Disruptor Would Build',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-purple-300 mb-2">Chapter B — Disruption Risk</div>
  ...
  // ================================================================
  // SLIDE 11: WHAT MUST CHANGE FOR DISRUPTION
  // ================================================================
  {
    id: 'what-must-change',
    title: 'What Must Change for Disruption to Be True',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-purple-300 mb-2">Chapter B — Disruption Risk</div>
  ...
  // ================================================================
  // SLIDE 12: BUILD-IT-TODAY REPLICABILITY
  // ================================================================
  {
    id: 'build-it-today',
    title: '"Build-It-Today" Replicability',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-purple-300 mb-2">Chapter B — Disruption Risk</div>
  ...
  // ================================================================
  // SLIDE 13: UNDERLYING ASSET VALUE — EXEC SUMMARY
  // ================================================================
  {
    id: 'asset-value-exec',
    title: 'Underlying Asset Value — Executive Summary',
    content: (
      <div className="space-y-6 px-4">
        <div>
  ...
  // ================================================================
  {
    ...
    title: 'Relationship Asset Strength',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-green-400 mb-2">Chapter C — Underlying Asset Value</div>
  ...
  // ================================================================
  // SLIDE 18: TEAM + OPERATING MODEL — EXEC SUMMARY
  // ================================================================
  {
    id: 'team-ops-exec',
    title: 'Team + Operating Model — Executive Summary',
    content: (
      <div className="space-y-6 px-4">
        <div>
  ...
  // ================================================================
  // SLIDE 20: FUNCTIONAL COVERAGE & RESOURCING
  // ================================================================
  {
    id: 'functional-coverage',
    title: 'Functional Coverage & Resourcing',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-taupe-300 mb-2">Chapter D — Team + Operating Model</div>
  ...
  // ================================================================
  // SLIDE 21: OPERATING MODEL MATURITY
  // ================================================================
  {
    id: 'operating-model-maturity',
  ...
  // ================================================================
  // SLIDE 22: AI ASSESSMENT — EXEC SUMMARY
  // ================================================================
  {
    id: 'ai-assessment-exec',
    title: 'AI Assessment — Executive Summary',
    content: (
      <div className="space-y-6 px-4">
        <div>
  ...
  // ================================================================
  // SLIDE 23: AI INVENTORY
  // ================================================================
  {
    id: 'ai-inventory',
    title: 'AI Inventory (What Exists)',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-gold mb-2">Chapter E — AI Assessment</div>
  ...
  // ================================================================
  // SLIDE 24: ARCHITECTURE SNAPSHOT + READINESS
  // ================================================================
  {
    id: 'architecture-readiness',
    title: 'Architecture Snapshot + Readiness',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-gold mb-2">Chapter E — AI Assessment</div>
  ...
  // ================================================================
  // SLIDE 25: AI VALUE FRAMEWORK
  // ================================================================
  {
    id: 'ai-value-framework',
  ...
  // ================================================================
  // SLIDE 26: AI VALUE & PROOF — EXAMPLES
  // ================================================================
  {
    id: 'ai-value-proof',
    title: 'AI Value & Proof — Examples',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-gold mb-2">Chapter E — AI Assessment</div>
  ...
  // ================================================================
  // SLIDE 27: BUYER ↔ TARGET SYNERGIES — EXEC SUMMARY
  // ================================================================
  {
    id: 'synergies-exec',
    title: 'Buyer ↔ Target Synergies — Executive Summary',
    content: (
      <div className="space-y-6 px-4">
        <div>
  ...
  // ================================================================
  // SLIDE 28: SYNERGY CONNECTIONS MATRIX
  // ================================================================
  {
    id: 'synergy-matrix',
    title: 'Synergy Connections Mapped to Assets',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-blue-400 mb-2">Chapter F — Buyer ↔ Target Synergies</div>
  ...
  // ================================================================
  // SLIDE 29: SYNERGY DETAIL (SELECTED CONNECTIONS)
  // ================================================================
  {
    id: 'synergy-detail',
    title: 'Synergy Detail (Selected Connections)',
    content: (
  ...
  {
    id: 'synergy-waves',
    title: 'Synergy Pathways (3 Waves)',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-blue-400 mb-2">Chapter F — Buyer ↔ Target Synergies</div>
  ...
  // ================================================================
  // SLIDE 31: PRIORITY INITIATIVES
  // ================================================================
  {
    id: 'priority-initiatives',
    title: 'Priority Initiatives — Assumptions + Uplift',
    content: (
      <div className="space-y-5 px-4">
        <div>
  ...
  // ================================================================
  // SLIDE 32: SENSITIVITY
  // ================================================================
  {
    id: 'sensitivity',
    title: 'Sensitivity: Impact on Growth Curve',
    content: (
      <div className="space-y-5 px-4">
        <div>
          <div className="text-xs uppercase tracking-wider text-red-400 mb-2">Chapter G — Quantified Impact</div>
...
export default function MercuryBuyerAIDiligencePage() {
  return (
    <DocumentAccessWrapper documentId="mercury-buyer-ai-diligence">
      <PresentationLayout
