...
export const metadata: Metadata = {
  title: 'Tweed Collective - Scale Health-Tech Revenue 2× Faster',
  description: 'Health-tech companies reach $10M ARR 2× faster with our fractional operators and AI-powered execution frameworks',
